...
@ContextConfiguration(initializers = {ConfigFileApplicationContextInitializer.class}, classes = {SpringKafkaConfiguration.class, MyListener.class})
@TestPropertySource(properties = {"spring.kafka.consumer.group-id=MyListenerTest-group", "my.topic.name=${MyListenerTest.topic}"}) // чтобы не было пересечений с другим тестом
